import { MagnifyingGlassIcon } from "@elise/icons";
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle } from "@elise/ui";
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        className={cn("overflow-hidden p-0 border border-border shadow-none", className)}
      >
...
function CommandList({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.List>) {
  return (
    <CommandPrimitive.List
      ...
      className={cn("max-h-[340px] scroll-py-1 overflow-x-hidden overflow-y-auto p-1", className)}
      {...props}
    />
  );
}
