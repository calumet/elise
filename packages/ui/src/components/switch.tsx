  ...
  ({ className, onCheckedChange, onChange, ...props }, ref) => (
    ...
    >
      <input
        ...
        {...props}
      />
      <span className="pointer-events-none block h-5 w-5 translate-x-1 rounded-full bg-background shadow-sm ring-1 ring-border transition peer-checked:translate-x-5" />
    </label>
  ),
);
