/**
 * Escribe `src/tokens.generated.ts` leyendo la hoja de `@calumet/elise-ui`.
 *
 ...
 * ninguna parte, porque entonces el tema tendría una variable sin valor base.
 */
...
console.log(`${names.length} variables, ${dark.size} redefinidas en oscuro.`);
